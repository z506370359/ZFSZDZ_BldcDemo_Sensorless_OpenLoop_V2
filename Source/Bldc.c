...
void BldcStateMachine(void)
{
    ...
    switch(tBldc.State)
    {
        case STOP_STATE: //停止状态
            ...
            break;
        case ORIENT_INITFIRST_STATE: //第一次预定位初始状态
            ...
            tBldc.State = ORIENT_INITSECOND_STATE;
            break;
        case ORIENT_INITSECOND_STATE: //第二次预定位初始状态
